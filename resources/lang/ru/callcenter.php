...
return [
    ...
    'order' => [
        ...
        'change_due' => 'Сдача',
        'currency_uah' => 'грн',
        'fiscalize_in_cashalot' => 'Фискализировать в кассе',
        'fiscalize_in_cashalot_help' => 'Доступно только для оплаты наличными или POS-терминалом.',
        'send_cashalot_receipt' => 'Отправить чек ПРРО',
