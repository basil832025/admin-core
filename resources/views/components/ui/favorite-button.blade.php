...
'active'    => false,
'color'     => '#FF7500',
// если хочешь сразу слать на сервер — передай URL (или оставь null)
'postUrl'   => null,
])

<button
    x-data="{ active: @js((bool)($active ?? false)) }"
    @click="active = !active"
...
>
    ...
    <svg width="28" x-show="!active" height="25" viewBox="0 0 28 25"  xmlns="http://www.w3.org/2000/svg">
        <path d="M14.1334 20.9384L14.0001 21.0717L13.8534 20.9384C7.52008 15.1917 3.33341 11.3917 3.33341 7.53841C3.33341
    ...
    <svg width="28" x-show="active" height="25" viewBox="0 0 28 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14 24.4667L12.0666 22.7067C5.19996 16.48 0.666626 12.36 0.666626 7.33333C0.666626 3.21333 3.89329 0 7.99996 0C10.32 0 12.5466 1.08 14 2.77333C15.4533 1.08 17.68 0 20 0C24.1066 0 27.3333 3.21333 27.3333 7.33333C27.3333 12.36 22.8 16.48 15.9333 22.7067L14 24.4667Z"
              fill="#FF7500"/>
    </svg>
