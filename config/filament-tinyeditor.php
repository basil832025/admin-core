...
return [
    ...
    'profiles' => [
        'default' => [
            'plugins' => 'accordion autoresize codesample directionality advlist link image code lists preview pagebreak searchreplace wordcount code fullscreen insertdatetime media table emoticons',
            'toolbar' => 'undo redo removeformat | fontfamily fontsize fontsizeinput font_size_formats styles | bold italic underline | rtl ltr | alignjustify alignleft aligncenter alignright | numlist bullist outdent indent | forecolor backcolor | blockquote table toc hr | code image link media codesample emoticons | wordcount fullscreen',
            'upload_directory' => null,
            'custom_configs' => [
                // если используешь плагин autoresize:
                'min_height' => 120,
               // 'max_height' => 240,
                'autoresize_bottom_margin' => 0,
                'autoresize_overflow_padding' => 0,
                'statusbar'=> true,   // нужен для ручки
                'resize'   => true,   // разрешить перетягивание
                // либо без autoresize можно задать фикс:
                // 'height' => 200,
            ],
        ...
        'custom' => [
            ...
            'toolbar' => 'undo redo | styles | bold italic | alignleft aligncenter alignright | bullist numlist | link image table | code fullscreen',
            'upload_directory' => null,
        ],
        'simple' => [
        ...
        'full' => [
            ...
            'toolbar' => 'undo redo removeformat | fontfamily fontsize fontsizeinput font_size_formats styles | bold italic underline | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist outdent indent accordion | forecolor backcolor | blockquote table toc hr | image link anchor media code codesample emoticons | visualblocks print preview wordcount fullscreen help',
            'upload_directory' => null,
           'toolbar_sticky' => false,
            'custom_configs' => [
