...
class TimeDiscountPolicy
{
     ...
     */
    public function view(User $user, TimeDiscount $timeDiscount): bool
    {
     ...
     */
    public function update(User $user, TimeDiscount $timeDiscount): bool
    {
     ...
     */
    public function delete(User $user, TimeDiscount $timeDiscount): bool
    {
     ...
     */
    public function forceDelete(User $user, TimeDiscount $timeDiscount): bool
    {
     ...
     */
    public function restore(User $user, TimeDiscount $timeDiscount): bool
    {
     ...
     */
    public function replicate(User $user, TimeDiscount $timeDiscount): bool
    {
