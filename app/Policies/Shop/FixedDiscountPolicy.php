...
class FixedDiscountPolicy
{
     ...
     */
    public function view(Authenticatable $user, FixedDiscount $fixedDiscount): bool
    {
        if (!$user instanceof User) {
     ...
     */
    public function update(Authenticatable $user, FixedDiscount $fixedDiscount): bool
    {
        if (!$user instanceof User) {
     ...
     */
    public function delete(Authenticatable $user, FixedDiscount $fixedDiscount): bool
    {
        if (!$user instanceof User) {
     ...
     */
    public function forceDelete(Authenticatable $user, FixedDiscount $fixedDiscount): bool
    {
        if (!$user instanceof User) {
     ...
     */
    public function restore(Authenticatable $user, FixedDiscount $fixedDiscount): bool
    {
        if (!$user instanceof User) {
     ...
     */
    public function replicate(Authenticatable $user, FixedDiscount $fixedDiscount): bool
    {
        if (!$user instanceof User) {
