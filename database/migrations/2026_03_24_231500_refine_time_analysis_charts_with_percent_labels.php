                        ...
                        <tr>
                            <td style="width:235px;vertical-align:top;">
                                <div style="position:relative;width:220px;height:220px;margin:0 auto;">
                                    ...
                                    {% if rec_p1 > 0 %}<div style="position:absolute;left:97px;top:8px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p1|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p2 > 0 %}<div style="position:absolute;left:176px;top:72px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p2|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p3 > 0 %}<div style="position:absolute;left:146px;top:170px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p3|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p4 > 0 %}<div style="position:absolute;left:42px;top:177px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p4|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p5 > 0 %}<div style="position:absolute;left:7px;top:84px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p5|number_format(0, '.', ' ') }}%</div>{% endif %}
                                </div>
                            </td>
                        ...
                        <tr>
                            <td style="width:235px;vertical-align:top;">
                                <div style="position:relative;width:220px;height:220px;margin:0 auto;">
                                    ...
                                    {% if del_p1 > 0 %}<div style="position:absolute;left:97px;top:8px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p1|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p2 > 0 %}<div style="position:absolute;left:176px;top:72px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p2|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p3 > 0 %}<div style="position:absolute;left:146px;top:170px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p3|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p4 > 0 %}<div style="position:absolute;left:42px;top:177px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p4|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p5 > 0 %}<div style="position:absolute;left:7px;top:84px;font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p5|number_format(0, '.', ' ') }}%</div>{% endif %}
                                </div>
                            </td>
                            <td style="vertical-align:top;">
                                <table class="report" style="font-size:11px;">
