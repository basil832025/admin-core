                        ...
                        <tr>
                            <td style="width:235px;vertical-align:top;">
                                <div style="position:relative;width:220px;height:220px;margin:0 auto;">
                                    <div style="width:220px;height:220px;border-radius:50%;background:conic-gradient({{ colors[0] }} 0% {{ rec_a|number_format(4, '.', '') }}%, {{ colors[1] }} {{ rec_a|number_format(4, '.', '') }}% {{ rec_b|number_format(4, '.', '') }}%, {{ colors[2] }} {{ rec_b|number_format(4, '.', '') }}% {{ rec_c|number_format(4, '.', '') }}%, {{ colors[3] }} {{ rec_c|number_format(4, '.', '') }}% {{ rec_d|number_format(4, '.', '') }}%, {{ colors[4] }} {{ rec_d|number_format(4, '.', '') }}% 100%);"></div>
                                    <div style="position:absolute;left:50%;top:50%;width:94px;height:94px;transform:translate(-50%, -50%);background:#fff;border-radius:50%;border:1px solid #e2e8f0;"></div>
                                    <div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);font-size:11px;font-weight:700;color:#334155;">{{ rec_total }}</div>

                                    {% if rec_p1 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ rec_m1|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ rec_m1|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p1|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p2 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ rec_m2|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ rec_m2|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p2|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p3 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ rec_m3|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ rec_m3|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p3|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p4 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ rec_m4|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ rec_m4|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p4|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if rec_p5 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ rec_m5|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ rec_m5|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ rec_p5|number_format(0, '.', ' ') }}%</div>{% endif %}
                                </div>
                            </td>
                ...
                <table style="width:100%;border-collapse:collapse;">
                    <tbody>
                        <tr>
                            <td style="width:235px;vertical-align:top;">
                                <div style="position:relative;width:220px;height:220px;margin:0 auto;">
                                    <div style="width:220px;height:220px;border-radius:50%;background:conic-gradient({{ colors[0] }} 0% {{ del_a|number_format(4, '.', '') }}%, {{ colors[1] }} {{ del_a|number_format(4, '.', '') }}% {{ del_b|number_format(4, '.', '') }}%, {{ colors[2] }} {{ del_b|number_format(4, '.', '') }}% {{ del_c|number_format(4, '.', '') }}%, {{ colors[3] }} {{ del_c|number_format(4, '.', '') }}% {{ del_d|number_format(4, '.', '') }}%, {{ colors[4] }} {{ del_d|number_format(4, '.', '') }}% 100%);"></div>
                                    <div style="position:absolute;left:50%;top:50%;width:94px;height:94px;transform:translate(-50%, -50%);background:#fff;border-radius:50%;border:1px solid #e2e8f0;"></div>
                                    <div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);font-size:11px;font-weight:700;color:#334155;">{{ del_total }}</div>

                                    {% if del_p1 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ del_m1|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ del_m1|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p1|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p2 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ del_m2|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ del_m2|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p2|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p3 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ del_m3|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ del_m3|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p3|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p4 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ del_m4|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ del_m4|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p4|number_format(0, '.', ' ') }}%</div>{% endif %}
                                    {% if del_p5 >= 4 %}<div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%) rotate({{ del_m5|number_format(2, '.', '') }}deg) translate(86px,0) rotate(-{{ del_m5|number_format(2, '.', '') }}deg);font-size:11px;font-weight:700;color:#1f2937;background:#fff;padding:1px 4px;border-radius:8px;border:1px solid #cbd5e1;">{{ del_p5|number_format(0, '.', ' ') }}%</div>{% endif %}
                                </div>
                            </td>
                            <td style="vertical-align:top;">
                                <table class="report" style="font-size:11px;">
